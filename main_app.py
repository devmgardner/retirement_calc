...
class calc_window:
    def __init__(self, top=None):
        ...
        self.data_frame.place(relx=0.01, rely=0.008, relheight=0.976, relwidth=0.75)
        ...
        #
        self.savings_buton = tk.Button(self.top)
        self.savings_buton.place(relx=0.91, rely=0.229, height=20, width=65)
        self.savings_buton.configure(activebackground="#ececec")
        self.savings_buton.configure(activeforeground="#000000")
        self.savings_buton.configure(background="#d9d9d9")
        self.savings_buton.configure(disabledforeground="#a3a3a3")
        self.savings_buton.configure(foreground="#000000")
        self.savings_buton.configure(highlightbackground="#d9d9d9")
        self.savings_buton.configure(highlightcolor="black")
        self.savings_buton.configure(pady="0")
        self.savings_buton.configure(text='''Update''')
